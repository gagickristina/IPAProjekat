<%-- 
    ...
    Created on : Aug 24, 2022, 5:52:56 PM
    Author     : m
--%>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md  mb-4">
                                ...
                                <h4 class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted">Vaša rezervacija porudžbine</span>
                                    <span class="badge badge-secondary badge-pill">Za datum: <%=datum%></span>
                            </h4>
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    <div>
                                        <h6 class="my-0"><%=usluga.getNaziv()%> </h6>
                                ...
                                <li class="list-group-item d-flex justify-content-between bg-light">
                                    ...
                                    <div class="text-success">
                                        <h6 class="my-0">Vas broj poena nakon porudžbine:</h6>
                            ...
                            <a href="Logout"> <button class="btn btn-secondary">Potvrdi</button> <a/>
                                <a href="rezervacije.jsp"> <button class="btn btn-secondary">Vrati se</button> <a/>
