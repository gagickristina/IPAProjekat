<%-- 
    ...
    Created on : Aug 25, 2022, 6:30:21 PM
    Author     : m
--%>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <form action="dodajUsluguForma.jsp" method="post">
                                            <button type="submit" class="btn btn-info" style="color: white;background-color: purple">Dodaj uslugu</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="PregledUsluga" method="post">
                                            <button type="submit" class="btn btn-info" style="color: white;background-color: purple">Pregledaj usluge</button>
                                            <input type="hidden" value="<%= a.getIdAgencije()%>" name="idAgencije" />
                                        </form>
                                    </td>
                                     <td>
                                        <form action="IzmenaAgencijaForma" method="post">
                                            <button type="submit" class="btn btn-info" style="color: white;background-color: purple">Izmeni agenciju</button>
                                            <input type="hidden" value="<%= a.getIdAgencije()%>" name="idAgencije" />
                                        </form>
                                    </td>
                                </tr>
