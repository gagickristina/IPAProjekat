<%-- 
    Document   : gallery
    Created on : Aug 18, 2022, 3:46:09 PM
    Author     : m
--%>
    ...
    <div class="gallery_area">
        <div class="container">
            ...
            <div class="row  grid">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 grid-item">
                    <div class="single_gallery mini_height gallery_bg_8">
                        <a href="img/gallery/8.png" class="popup-image"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 grid-item">
                    <div class="single_gallery mini_height gallery_bg_9">
                        <a href="img/gallery/9.png" class="popup-image"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 grid-item">
                    <div class="single_gallery mini_height gallery_bg_10">
                        <a href="img/gallery/10.png" class="popup-image"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 grid-item">
                    <div class="single_gallery mini_height gallery_bg_11">
                        <a href="img/gallery/11.png" class="popup-image"></a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 grid-item">
                    <div class="single_gallery mini_height gallery_bg_12">
                        <a href="img/gallery/12.png" class="popup-image"></a>
                    </div>
                </div>
            </div>
