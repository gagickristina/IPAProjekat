<%-- 
    ...
    Created on : Aug 25, 2022, 6:41:56 PM
    Author     : m
--%>
                        ...
                        <table class="table table-striped" style="border: 1px white">
                            <thead>
                                <tr>
                                    ...
                                    <th><a href="ispisAgencija.jsp"><button  class="btn btn-info" style="color: white;background-color: purple">Vrati se</button></a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <%
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="IzmenaUslugaForma" method="post">
                                            <button type="submit" class="btn btn-info" style="color: white;background-color: purple">Izmeni uslugu</button>
                                    ...
                                    <td>
                                        <form action="BrisanjeUsluga" method="post">
                                            <button type="submit" class="btn btn-info" style="color: white;background-color: purple">Obrisi uslugu</button>
                                            <input type="hidden" value="<%= u.getIdUsluge()%>" name="idUsluge" />
                                        </form>
                                    </td>
