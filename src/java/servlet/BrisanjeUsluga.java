 ...
 * @author m
 */
public class BrisanjeUsluga extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String upit2="DELETE FROM usluga WHERE idUsluge=?";
            PreparedStatement BSK =konekcija.prepareStatement(upit2);
            BSK.setInt(1, idUsluge);
            BSK.executeUpdate();
            konekcija.close();
        ...
        {
            request.setAttribute("poruka", "Nije moguce obrisati rezervaciju "+ex );
